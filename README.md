...
![joins](Analysis/Topics//Joins.png)

Player performance analysis
![select](Analysis/Topics//view_all_columns.png)

Top Run Scorers and Top Wicket Takers
![joins](Analysis/Topics//Joins.png)

Player rankings using RANK() window function
![window](Analysis/Topics//window_functions.png)

Venue-based wicket insights
![subqueries](Analysis/Topics//Using_Subqueries.png)
